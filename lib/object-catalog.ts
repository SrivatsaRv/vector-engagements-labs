...
export const OBJECT_CATALOG: CatalogObject[] = [
  ...
  { id: "f-16c-block52-paf", designation: "F-16C Block 52", name: "Fighting Falcon", kind: "AIRCRAFT", symbolRole: "FIGHTER", country: "Pakistan", description: "One of 12 single-seat Peace Drive I aircraft. Engine, radar, data-link, and weapon associations are categorical context only; named performance and fitted defensive EW remain unsupported.", domains: ["A2A", "G2A"], dataState: "PUBLIC_REFERENCE", service: "PAF", sourceIds: ["lockheed-paf-f16-2009", "federal-register-paf-f16-2006", "us-congress-paf-amraam-2008"] },
