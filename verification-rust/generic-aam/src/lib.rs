...
#[allow(unsafe_code)]
#[no_mangle]
pub extern "C" fn vector_generic_aam_abi_version() -> u32 {
    ABI_VERSION
}

#[allow(unsafe_code)]
#[no_mangle]
pub extern "C" fn vector_generic_aam_max_input_len() -> usize {
    MAX_INPUT_BYTES
}

#[allow(unsafe_code)]
#[no_mangle]
pub extern "C" fn vector_generic_aam_input_reserve(length: usize) -> *mut u8 {
...
#[allow(unsafe_code)]
#[no_mangle]
pub extern "C" fn vector_generic_aam_output_ptr() -> *const u8 {
    OUTPUT.with(|cell| cell.borrow().as_ptr())
}

#[allow(unsafe_code)]
#[no_mangle]
pub extern "C" fn vector_generic_aam_output_len() -> usize {
