...
export default function LandingPage() {
  return <main className="landing">
    ...
    <footer className="landing-footer"><div className="brand"><span>V</span><div><strong>Vector</strong><small>Engagement Labs</small></div></div><p>Educational simulation using public-data assumptions. Not a verified performance or operational prediction.</p><Link href="/scenarios">Browse scenarios <ArrowRight size={14}/></Link></footer>
  </main>;
}
