...
export default function LandingPage() {
  return <main className="landing">
    ...
    <section className="landing-section" id="how"><div className="section-heading"><span>One clear loop</span><h2>Built for curious minds,<br/>not aerospace specialists.</h2><p>Start from a complete scenario. Replace an object or change one condition; the model explains the resulting geometry and outcome.</p></div><div className="journey-grid"><Journey number="01" icon={SlidersHorizontal} title="Configure" copy="Review the Blue Team, Red Team, weapon system, starting distance, altitude, flight path, and model limits."/><Journey number="02" icon={Play} title="Run" copy="Watch the relative flight paths and calculated state change over model time."/><Journey number="03" icon={GitCompare} title="Compare" copy="Change one object or condition, repeat the run, and see which result changed."/><Journey number="04" icon={FileText} title="Results" copy="Record what was tested, who was involved, the conditions, the outcome, and the model limits."/></div></section>
