...
export default function LandingPage() {
  return <main className="landing">
    ...
    <section className="scenario-section" id="scenarios"><div className="scenario-section-heading"><div><span className="overline">Scenario library · versioned templates</span><h2>Begin with the mission set.</h2></div><div><p>Choose Air Intercept, Air-to-Surface, Surface-to-Air Defence, or Surface Strike. Every template opens a configured, reproducible lab state using generalized settings and synthetic objectives.</p><Link href="/scenarios">View all scenarios <ArrowRight size={14}/></Link></div></div><ScenarioLibrary compact/></section>
