...
function LabWorkbench({
  ...
  const [result, setResult] = useState(() =>
    simulate({ ...initialDefinition.scenario, engineBackend: "typescript" }),
  );
    ...
    <section className="build-workspace">
          ...
          <section className="authoring-section">
            ...
            {advanced && (
              <>
                ...
                <div className="engine-backend-control">
                  <header>
                    <span>Simulation engine</span>
                    <strong>Choose the browser execution backend.</strong>
                  </header>
                  <div className="geometry-choice">
                    {ENGINE_BACKENDS.map((backend) => (
                      <button
                        className={scenario.engineBackend === backend.id ? "active" : ""}
                        key={backend.id}
                        onClick={() => update("engineBackend", backend.id)}
                        type="button"
                      >
                  ...
                  <p>
                    The selected backend is frozen with the run. VECTOR never silently switches engines after you start a simulation.
                  </p>
                </div>
              </>
            )}
      ...
      <aside className="builder-summary">
        ...
        <dl>
          ...
          <dd>{scenario.engineBackend === "rust-wasm" ? "Rust / WebAssembly" : "TypeScript reference"}</dd>
