...
import { ArrowLeft, BookOpen, Database, ShieldCheck } from "lucide-react";
import { ScenarioLibrary } from "@/components/ScenarioLibrary";

export default function ScenariosPage() {
  return <main className="library-page">
    <header className="library-page-nav"><Link href="/"><ArrowLeft size={14}/>VECTOR</Link><span>Scenario Library</span><Link href="/lab">Open blank studio</Link></header>
