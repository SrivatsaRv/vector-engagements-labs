...
test("the manifest rejects identity, decision, role, page, unit, datum, and executable-field drift", () => {
  const attacks = [
    ...
    ["unknown decision field", (value) => { value.decisions.referenceUse.surprise = true; }],
    ...
    ["forged decision", (value) => { value.decisions.referenceUse.value = "APPROVED_INTERNAL_VERIFICATION_ONLY"; }],
...
test("production code and built runtime inputs cannot import or name the source-only contract", () => {
  ...
  try {
    ...
    writeFileSync(resolve(attackRoot, "engine-rust", "src", "forged.rs"), "NASA_TM87766_FSD_F16A_DECOUPLER_FLIGHT_TEST");
