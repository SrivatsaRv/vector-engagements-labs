...
The current separate corpus is `governance/nasa-tm-109057-generic-aam-verification-corpus.v5.json`, 11,521 bytes with raw-file SHA-256 `bb8599aefa2b698396db6aa2dbdbae2e541532486e189e5a34b993a9f2bd9204`. Its canonical object SHA-256 is `e799212813fba8b635ee4b8bce114af842ba6a38ef0fb3fbcf21f32b4be55420`; its decision-array SHA-256 is `884bca829ac1b94f959ecff1be6b9cf9847512810c7010f36d8b78cf6cef22f2`. The offline verifier now admits the exact raw corpus bytes before it checks the parsed object and NASA PDF; a whitespace-only or otherwise canonically equivalent replacement fails. Immutable v1–v4 remain readable for ancestry; v5 owns executable admission. In particular, v3 remains exactly 7,456 bytes with raw-file SHA-256 `57af85c0bafdb47563e4bd09cce08d329f4044b52adbf50c6e1a072e228d81b3`, and reviewed v4 remains exactly 7,456 bytes with raw-file SHA-256 `7d680b9417e074757f0ab7426ff46bb773e8000191c501a99d386a4d023061a5`. The imported corpus is frozen behind a private module boundary and its source, corpus, and decision identities are fixed compiled constants. Callers receive recursively frozen copies, never the trusted singleton. Mutation of a caller view, forged source/hash values, or mutation of the DCS/War Thunder, parity-policy, and prohibited-surface lists cannot change current or later admission.
...
Raw-byte admission strengthens the identity boundary only; it does not add an
evidence role or permit a canonically equivalent descendant to inherit review.
...
The closed Apple M5 timing profile proves only the declared Node-hosted
verification workload on that exact environment; Git identity and clean state
do not promote its timings into product or named-system capability.
